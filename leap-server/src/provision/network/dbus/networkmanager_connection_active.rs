// This code was autogenerated with `dbus-codegen-rust --file /home/javier/code/NetworkManager/introspection/org.freedesktop.NetworkManager.Connection.Active.xml`, see https://github.com/diwic/dbus-rs
use dbus as dbus;
