// This code was autogenerated with `dbus-codegen-rust --file /home/javier/code/NetworkManager/introspection/org.freedesktop.NetworkManager.Device.xml`, see https://github.com/diwic/dbus-rs
use dbus as dbus;
...
pub trait OrgFreedesktopNetworkManagerDevice {
    ...
    fn set_managed_(&self, managed: u32, flags: u32) -> Result<(), dbus::Error>;
...
impl<'a, T: blocking::BlockingSender, C: ::std::ops::Deref<Target=T>> OrgFreedesktopNetworkManagerDevice for blocking::Proxy<'a, C> {
    ...
    fn set_managed_(&self, managed: u32, flags: u32) -> Result<(), dbus::Error> {
        self.method_call("org.freedesktop.NetworkManager.Device", "SetManaged", (managed, flags, ))
    }
