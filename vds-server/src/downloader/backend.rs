...
type ChunkResult = Result<Vec<u8>, Error>;
...
mod test {
    ...
    #[tokio::test]
    async fn read_resource_using_file_backend() {
        ...
        std::fs::write(&resource_filepath, &v[..]).unwrap();
        ...
        std::fs::remove_file(resource_filepath);
